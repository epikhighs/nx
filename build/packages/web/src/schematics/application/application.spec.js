...
describe('app', () => {
    ...
    describe('not nested', () => {
        ...
        it('should generate files', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(tree.exists('apps/my-app/src/app/app.element.spec.ts')).toBeTruthy();
            ...
            const tsconfigApp = JSON.parse(stripJsonComments(tree.readContent('apps/my-app/tsconfig.app.json')));
            expect(tsconfigApp.compilerOptions.outDir).toEqual('../../dist/out-tsc');
            expect(tsconfigApp.extends).toEqual('./tsconfig.json');
            const tslintJson = JSON.parse(stripJsonComments(tree.readContent('apps/my-app/tslint.json')));
            expect(tslintJson.extends).toEqual('../../tslint.json');
            expect(tree.exists('apps/my-app-e2e/cypress.json')).toBeTruthy();
            const tsconfigE2E = JSON.parse(stripJsonComments(tree.readContent('apps/my-app-e2e/tsconfig.e2e.json')));
    ...
    it('should create Nx specific template', () => __awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('app', { name: 'myApp', directory: 'myDir' }, appTree);
        expect(tree.readContent('apps/my-dir/my-app/src/app/app.element.ts')).toBeTruthy();
        expect(tree.readContent('apps/my-dir/my-app/src/app/app.element.ts')).toContain('Thank you for using and showing some ♥ for Nx.');
    }));
    describe('--style scss', () => {
        it('should generate scss styles', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(result.exists('apps/my-app/src/app/app.element.scss')).toEqual(true);
        }));
    });
    it('should setup jest without serializers', () => __awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('app', {
            name: 'my-App'
        }, appTree);
        expect(tree.readContent('apps/my-app/jest.config.js')).not.toContain(`'jest-preset-angular/build/AngularSnapshotSerializer.js',`);
    }));
    it('should setup the nrwl web build builder', () => __awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('app', {
            name: 'my-App'
        }, appTree);
        const workspaceJson = workspace_1.readJsonInTree(tree, 'workspace.json');
    ...
    it('should setup the nrwl web dev server builder', () => __awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('app', {
            name: 'my-App'
        }, appTree);
        const workspaceJson = workspace_1.readJsonInTree(tree, 'workspace.json');
    ...
    it('should setup the tslint builder', () => __awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testing_2.runSchematic('app', {
            name: 'my-App'
        }, appTree);
        const workspaceJson = workspace_1.readJsonInTree(tree, 'workspace.json');
    ...
    describe('--prefix', () => {
        it('should use the prefix in the index.html', () => __awaiter(void 0, void 0, void 0, function* () {
            const tree = yield testing_2.runSchematic('app', { name: 'myApp', prefix: 'prefix' }, appTree);
            expect(tree.readContent('apps/my-app/src/index.html')).toContain('<prefix-root></prefix-root>');
        }));
    });
