...
describe('normalizeBuildOptions', () => {
    ...
    it('should resolve both node modules and relative path for webpackConfig', () => {
        ...
        result = normalize_1.normalizeBuildOptions(Object.assign(Object.assign({}, testOptions), { webpackConfig: 'react' }), root, sourceRoot);
...
describe('normalizePackageOptions', () => {
    ...
    it('should resolve both node modules and relative path for babelConfig/rollupConfig', () => {
        let result = normalize_1.normalizePackageOptions(testOptions, root, sourceRoot);
        ...
        result = normalize_1.normalizePackageOptions(Object.assign(Object.assign({}, testOptions), { 
            // something that exists in node_modules
            rollupConfig: 'react', babelConfig: 'react' }), root, sourceRoot);
    ...
    it('should handle babelConfig/rollupConfig being undefined', () => {
        ...
        const result = normalize_1.normalizePackageOptions(testOptions, root, sourceRoot);
