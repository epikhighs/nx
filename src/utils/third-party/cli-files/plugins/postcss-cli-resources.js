...
exports.default = postcss.plugin('postcss-cli-resources', (options) => {
    ...
    const process = (inputUrl, context, resourceCache) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (root) => {
        ...
        return Promise.all(urlDeclarations.map((decl) => __awaiter(void 0, void 0, void 0, function* () {
